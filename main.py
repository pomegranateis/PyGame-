...
# Load player image with a transparent background
player_img = pygame.image.load("/home/pomegranateu/pygame/6206454607187545408.webp").convert_alpha()
player_img = pygame.transform.scale(player_img, (65, 65))

# Load obstacle images with transparent backgrounds
obstacle_imgs = [
    pygame.image.load("/home/pomegranateu/pygame/6206454607187545401.webp").convert_alpha(),
    pygame.image.load("/home/pomegranateu/pygame/6206454607187545402.webp").convert_alpha(),
    pygame.image.load("/home/pomegranateu/pygame/6206454607187545408.webp").convert_alpha(),
]
...
font = pygame.font.Font("/home/pomegranateu/pygame/Super Milk.ttf", 48)  # Default font
home_font = pygame.font.Font("/home/pomegranateu/pygame/Minecrafter.Reg.ttf", 72)  # Custom font with a transparent background
...
# Load sound effects
shoot_sound = pygame.mixer.Sound("/home/pomegranateu/pygame/shoot.mp3")
explosion_sound = pygame.mixer.Sound("/home/pomegranateu/pygame/explosion.mp3")
...
player_x = WIDTH // 2
player_y = HEIGHT - 50
player_speed = 8  # Increase the player's movement speed
player_bullet_x = 0
...
home_screen_background = pygame.image.load("/home/pomegranateu/pygame/game_background.jpg").convert_alpha()
home_screen_background = pygame.transform.scale(home_screen_background, (WIDTH, HEIGHT))

game_screen_background = pygame.image.load("/home/pomegranateu/pygame/game_background.jpg").convert_alpha()
...
def draw_game_screen():
    global player_bullet_state, player_score, player_bullet_y, game_state
    ...
    for i, obstacle in enumerate(obstacles):
        if obstacle[2] == "active":
            ...
            if (
                ...
                game_state = GameState.GAME_OVER_SCREEN
...
while running:
    ...
    if keys[pygame.K_RIGHT] and player_x < WIDTH - 65:
        player_x += player_speed

    if game_state == GameState.HOME_SCREEN:
        draw_home_screen()
    ...
    elif game_state == GameState.GAME_OVER_SCREEN:
